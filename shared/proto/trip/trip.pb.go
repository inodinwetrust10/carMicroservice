...
// Static driver obj that is used to store the driver
...
const file_trip_proto_rawDesc = "" +
	...
	"\bcarPlate\x18\x04 \x01(\tR\bcarPlate\"K\n" +
...
var file_trip_proto_goTypes = []any{
	...
	(*TripDriver)(nil),          // 6: trip.TripDriver
	(*CreateTripRequest)(nil),   // 7: trip.CreateTripRequest
...
var file_trip_proto_depIdxs = []int32{
	...
	2,  // 5: trip.Route.geometry:type_name -> trip.Geometry
	9,  // 6: trip.CreateTripResponse.trip:type_name -> trip.Trip
	5,  // 7: trip.Trip.selectedFare:type_name -> trip.RideFare
	4,  // 8: trip.Trip.route:type_name -> trip.Route
	6,  // 9: trip.Trip.driver:type_name -> trip.TripDriver
	0,  // 10: trip.TripService.PreviewTrip:input_type -> trip.PreviewTripRequest
	7,  // 11: trip.TripService.CreateTrip:input_type -> trip.CreateTripRequest
